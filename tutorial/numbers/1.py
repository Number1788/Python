...
print((2/3)+(1/2))
import decimal                                      #Импортируем библиотеку чисел с фиксированной точностью
...
print(decimal.Decimal(1)/decimal.Decimal(7))        #деление с фиксированной точностью
decimal.getcontext().prec = 4                       #установка количества знаков после запятой
print(decimal.Decimal(1)/decimal.Decimal(7))
with decimal.localcontext() as ctx:                 #установка локального контекста(действует внутри цикла)
    ctx.prec = 3
    print(decimal.Decimal('1.00')/
